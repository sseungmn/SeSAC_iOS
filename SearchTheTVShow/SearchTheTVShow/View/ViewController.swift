...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(TVShowCollectionViewHeader.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: TVShowCollectionViewHeader.reuseIdentifier)
        
        let a = CollectionViewPractice()
    }
}
